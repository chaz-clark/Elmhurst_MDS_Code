...
#setwd("C:/Users/James/Documents")
#setwd("C:/Users/James/Documents/MDS 564 19SP")
getwd()
setwd("/Volumes/MacProHHD64MB/MovedUsers/ChazInkLLC/Documents/Documents - Mac Pro/Elmhurst/MDS 564 /Week1/Clean/")
#The parameters are set for tab-delimited files. These can be changed.
dataset1<-read.table(file="ticdata2000-training-v2(3).txt",header=TRUE,sep="\t",na.strings="*",stringsAsFactors=FALSE)
dataset1 #This gives you a glace at the data#
dataset2<-read.table(file="ticeval2000-validation-v2(3).txt",header=TRUE,sep="\t",na.strings="*",stringsAsFactors=FALSE)
dataset2
summary(dataset1)
str(dataset1)
```
